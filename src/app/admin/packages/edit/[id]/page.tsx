...
const EditPackageContent = () => {
  ...
  if (loading) return (
    <div className="flex min-h-screen bg-slate-50 items-center justify-center">
      <p className="text-xl font-bold text-primary animate-pulse">جاري تحميل بيانات العرض...</p>
    </div>
  );
    ...
    <div className="flex min-h-screen bg-slate-50 text-right" dir="rtl">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            <h1 className="text-3xl font-black text-slate-900 font-tajawal">تعديل عرض: {formData.title}</h1>
            <p className="text-muted text-sm mt-1">قم بتحديث بيانات العرض أدناه.</p>
          </div>
        </div>
